<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="aramamotoru.Default" %>
...
<body onload="document.forms.bing.query.focus();">
    ...
    bingSearchOptions(this), getSubscriptionKey())">
        ...
        <div id="logo">
            ...
            <p>
                <select name="where">
                    ...
                    <option value="tr-TR" selected>Turkey (Turkish)</option>
        ...
        <div id="query">
            <div><img src="Images/mcy_logo.png" alt="dotnetmcy" title="www.dotnetmcy.com" width="120" /></div>
            <!-- query controls including search field and options -->
            <h3>dotnetMCY Arama Motoru | Bing Web Search API demo</h3>
